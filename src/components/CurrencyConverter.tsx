...
const CurrencyConverter: React.FC = () => {
  ...
  const [into, setInto] = useState<string>("SGD - Singapore Dollar (S$)");
  ...
  return (
    <>
      <div className="container-fluid">
        <div className="currceny-bar">
          <div className="currency-app">
            <form action="currency-amount" className="amount-form">
              Amount
            </form>
            <input
            ...
            <div className="currency-swap">
              <button className="btn currency-swap-btn" onClick={handleSwitch}>
                <img className="currensy-swap" src={replay} alt="replay icon" />
              </button>
            </div>
